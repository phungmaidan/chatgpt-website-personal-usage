...
const isAuthorized = async (req, res, next) => {
  ...
  try {
    ...
    // Bước 02: Quan trọng: Nếu như cái token hợp lệ, thì sẽ cần phải lưu thông tin giải mã được vào req.jwtDecoded, để sử dụng cho các tầng cần xử lý ở phía sau
